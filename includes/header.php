        ...
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <?php if ($is_logged_in): ?>
                    ...
                    <a href="<?= htmlspecialchars($base_url) ?>/views/incomes.php" class="hover:text-emerald-200">Incomes</a> <a href="<?= htmlspecialchars($base_url) ?>/views/expenses.php" class="hover:text-emerald-200">Expenses</a> <a href="<?= htmlspecialchars($base_url) ?>/auth/logout.php"
