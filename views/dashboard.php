    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="<?= $base_url ?>/views/incomes.php" class="flex flex-col items-center justify-center bg-green-50 hover:bg-green-100 border border-green-200 p-4 rounded-lg text-center transition"><i data-lucide="plus-circle" class="h-8 w-8 text-green-600 mb-2"></i><p class="text-green-700 font-semibold">Add Income</p></a>
